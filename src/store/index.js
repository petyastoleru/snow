...
export default new Vuex.Store({
  state: {
    ...
    comments: [
      { commentID: 1, blogID: 1, name: 'John Leonard', date: "20 September, 2016", avatar: require('@/assets/images/post-6-mid.jpg'), commentText: "Nullam ac dui et purus malesuada gravida id fermentum orci. In eu ipsum quis urna hendrerit condimentum vitae a mauris. In congue turpis purus, vitae tempus ante id. Donec orci arcu, sagittis ut finibus vitae." },
      { commentID: 2, blogID: 1, name: 'John Leonard', date: "20 September, 2016", avatar: require('@/assets/images/post-6-mid.jpg'), commentText: "Nullam ac dui et purus malesuada gravida id fermentum orci. In eu ipsum quis urna hendrerit condimentum vitae a mauris. In congue turpis purus, vitae tempus ante id. Donec orci arcu, sagittis ut finibus vitae." },
      { commentID: 3, blogID: 2, name: 'John Leonard', date: "20 September, 2016", avatar: require('@/assets/images/post-6-mid.jpg'), commentText: "Nullam ac dui et purus malesuada gravida id fermentum orci. In eu ipsum quis urna hendrerit condimentum vitae a mauris. In congue turpis purus, vitae tempus ante id. Donec orci arcu, sagittis ut finibus vitae." },
      { commentID: 4, blogID: 3, name: 'John Leonard', date: "20 September, 2016", avatar: require('@/assets/images/post-6-mid.jpg'), commentText: "Nullam ac dui et purus malesuada gravida id fermentum orci. In eu ipsum quis urna hendrerit condimentum vitae a mauris. In congue turpis purus, vitae tempus ante id. Donec orci arcu, sagittis ut finibus vitae." },
